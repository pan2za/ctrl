...
%prep
if [ ! -d /home/z/new/ctrl/ctrl/contrail-fabric-utils]; then
    git clone ssh://git@bitbucket.org/contrail_admin/fabric-utils.git contrail-fabric-utils
else
    (cd /home/z/new/ctrl/ctrl/contrail-fabric-utils; )
fi
...
(cd /home/z/new/ctrl/ctrl/contrail-fabric-utils; %{__python} setup.py sdist)
...
pushd /home/z/new/ctrl/ctrl/contrail-fabric-utils
