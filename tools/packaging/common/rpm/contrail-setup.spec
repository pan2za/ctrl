...
%define          _builddir /home/z/cpl/ctrl/tools 
...
pushd /home/z/cpl/ctrl/controller/src/config
tar cvfz ../../cfgm_utils.tgz utils
popd

pushd /home/z/cpl/ctrl/controller/src/dns/scripts
...
# install etc files
install -p -m 644 /home/z/cpl/ctrl/controller/cfgm_utils.tgz  %{buildroot}%{_contrailopt}/cfgm_utils.tgz
install -p -m 644 /home/z/cpl/ctrl/controller/dns_scripts.tgz  %{buildroot}%{_contrailopt}/dns_scripts.tgz
pushd %{_provdir}
...
install -p -m 644 zope.interface-*.tar.gz %{buildroot}%{_contrailopt}/python_packages/
