...
Source0: https://pypi.python.org/packages/source/b/bitarray/bitarray-0.8.0.tar.gz 
License: PSF
Group: Development/Libraries
Prefix: %{_prefix}
Vendor: Ilan Schnell <ilanschnell@gmail.com>
